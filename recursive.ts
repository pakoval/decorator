...
function mathAnimalName(keyValue: string, name: string, animalChain: string[]): void {
    if(keyValue === name) {
...
function findAnimalChain(target: { [key: string]: any }, name: string, animalChain: string[]): string[] {
